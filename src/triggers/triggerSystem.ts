export class TriggerSystem implements ISystem {
    ...
    static get instance(): TriggerSystem { return this.createAndAddToEngine() }
    ...
    update() {
        ...
        let entitiesWithTriggers = engine.getComponentGroup(TriggerComponent).entities
    ...
    private static removeTriggerFromSystem(wrapper: TriggerWrapper) {
        ...
        for (let i = 0; i < activeCollisions.length; i++) {
            if (activeCollisions[i].trigger.onTriggerExit && wrapper.entity) (activeCollisions[i].trigger.onTriggerExit as (entity: IEntity) => void)(wrapper.entity)
    ...
    private static areColliding(t1: TriggerWrapper, t2: TriggerWrapper): boolean {
        if (t1.getShape() instanceof TriggerBoxShape && t2.getShape() instanceof TriggerBoxShape) {
            return TriggerSystem.areCollidingAABB(t1.getGlobalPosition(), t1.getShape() as TriggerBoxShape, t2.getGlobalPosition(), t2.getShape() as TriggerBoxShape)
        }
        else if (t1.getShape() instanceof TriggerSphereShape && t2.getShape() instanceof TriggerSphereShape) {
            return TriggerSystem.areCollidingSphere(t1.getGlobalPosition(), t1.getShape() as TriggerSphereShape, t2.getGlobalPosition(), t2.getShape() as TriggerSphereShape)
        }
        else if (t1.getShape() instanceof TriggerBoxShape && t2.getShape() instanceof TriggerSphereShape) {
            return TriggerSystem.areCollidingAABBSphere(t1.getGlobalPosition(), t1.getShape() as TriggerBoxShape, t2.getGlobalPosition(), t2.getShape() as TriggerSphereShape)
        }
        else if (t1.getShape() instanceof TriggerSphereShape && t2.getShape() instanceof TriggerBoxShape) {
            return TriggerSystem.areCollidingAABBSphere(t2.getGlobalPosition(), t2.getShape() as TriggerBoxShape, t1.getGlobalPosition(), t1.getShape() as TriggerSphereShape)
        }
        return false
    }

    private static areCollidingAABB(t1GlobalPosition: Vector3, t1Shape: TriggerBoxShape, t2GlobalPosition: Vector3, t2Shape: TriggerBoxShape): boolean {
    ...
    private static areCollidingSphere(t1GlobalPosition: Vector3, t1Shape: TriggerSphereShape, t2GlobalPosition: Vector3, t2Shape: TriggerSphereShape): boolean {
    ...
    private static areCollidingAABBSphere(t1GlobalPosition: Vector3, t1Shape: TriggerBoxShape, t2GlobalPosition: Vector3, t2Shape: TriggerSphereShape): boolean {
    ...
    private static getBoxShapeValues(entityGlobalPosition: Vector3, shape: TriggerBoxShape): { center: Vector3, min: Vector3, max: Vector3 } {
...
class TriggerWrapper {
    ...
    get entity(): Entity | undefined { return this._entity }
    get trigger(): TriggerComponent { return this._trigger }
